...
```bash
git clone https://github.com/tetrashop/EmotionPlayer.git
cd EmotionPlayer
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی EmotionPlayer روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/EmotionPlayer
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی EmotionPlayer روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
- **وضعیت:** ✅ فعال
- **آخرین به‌روزرسانی:** 2026-08-15 17:56
...
<!-- Trigger deploy: Mon Aug 17 01:47:37 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://EmotionPlayer.vercel.app](https://EmotionPlayer.vercel.app)
- **وضعیت:** ✅ فعال
